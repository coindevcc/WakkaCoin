    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a WakkaCoin address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a WakkaCoin address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter WakkaCoin signature"));
#endif
